...
$config['smsTemplates'] = array(
			...
			'registration' => 'Dear %username%, Thank You for choosing Dhangar Vivaah. Please verify Your account by clicking on the Link sent on your %registeredEmail%. Team Dhangar Vivaah',
