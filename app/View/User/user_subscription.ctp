          ...
          <div class="my-subscribe-account">
              <table class="u-full-width">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo __('Registered On');?> :</td>
                      <td><?php echo  CakeTime::nice($subInfo[0]->user_registered_on);?></td>
                    </tr>
                    <tr>
          ...
          <div class="subscribe-now content-style">
            <div class="row">
              <select name="sub_type" class="selected-amount" onchange="$('#sub_amount').val($(this).val())">
                ...
                <?php foreach($subOptions as $sub){
					if($sub->sub_id > 1){?>
                    <option value="<?php echo $sub->sub_amount;?>" <?php echo $sub->sub_amount == $chooseAmt ? "selected" : "";?>><?php echo $sub->sub_name;?> (<?php echo $sub->sub_amount;?> Rs)</option>
                <?php }
				}?>
              </select>
            </div>
            <div class="row">
              ...
              <div class="pay-by-cheque">
                ...
                <input class="check-amount" type="text" id="sub_amount" value="<?php echo $chooseAmt;?>" name="sub_amount" readonly>
              </div>
            </div>
            <div class="row">
